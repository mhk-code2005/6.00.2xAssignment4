...
def evaluate_models_on_training(x, y, models):
    ...
    pylab.plot(x,y,'b-o')
    for i in models:
        estYVals = pylab.polyval(i, x)


        pylab.plot(x,estYVals,label=str(r_squared(y,estYVals)))
        pylab.legend()
        pylab.legend(loc='best')
    
x=np.array([40, 35, 30, 25, 20, 18, 16, 15, 14])
y=np.array([14, 15, 16, 17, 20, 22, 26, 30, 34 ])
